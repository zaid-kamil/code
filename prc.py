...
spell_model = gensim.models.KeyedVectors.load_word2vec_format('E:\wiki-news-300d-1M.vec\wiki-news-300d-1M.vec')
...
print("Loading data ...")
train = pd.read_csv('E:\Insincer question classification\quora-insincere-questions-classification\train.csv').fillna(' ')
test = pd.read_csv('E:\Insincer question classification\quora-insincere-questions-classification\test.csv').fillna(' ')
